                    ...
                    <section className={cx('descriptionWrap')}>
                        <article className={cx('descriptionContainer')}>
                            ...
                            <span className={cx('contents')}>
                                ...
                                붙여넣고 리디렉션 생성 버튼을 만들면 리디렉션
                                링크를 만들 수 있습니다. 이후, 원하는 부분에
                                리디렉션 소스를 붙여넣어 쿠팡 파트너스
                                리디렉션을 사용할 수 있습니다.
                            </span>
                        </article>
                        <article className={cx('descriptionContainer')}>
                            ...
                            <span className={cx('contents')}>
                                기존 쿠팡파트너스 링크를 사용할 때 발생하는
                                블로그 저품질 문제를 해결하기 위해 일반 웹사이트
                                도메인을 사용하여 블로그 크롤링 봇이 링크를
                                크롤링 할 때 저품질 블로그라 판단하지 못하도록
                                합니다.
                            </span>
                        </article>
                        <article className={cx('descriptionContainer')}>
                        ...
                        <article className={cx('descriptionContainer')}>
                            ...
                            <span className={cx('contents')}>
                                온라인 리디렉션 생성기는 사용자의 수익 보장을
                                위해 제작 되어졌습니다. 사용자의 수익은 제작자의
                                큰 힘이 됩니다.
                            </span>
                        </article>
                    </section>
